...
const CONFIG = {
    ...
    entry: {     
        "project-name": ["./src/scripts/index.js"]     
    },
    output: {
    ...
    plugins: [
        ...
        new HTML_WEBPACK_PLUGIN({
          title: "title defined in webpack.dev.config.jsewifiuguefgwiufgeigiwuf",
...
const SCSS_RULE_PROD = { // styles extracted to .css file
    ...
    use: EXTRACT_STYLESHEETS.extract({
        ...
        use: [
            ...
            "postcss-loader", // IMPORTANT NOTE: for this to work all @import statements must be explicit, i.e. @import "_theme.scss" instead of @import "theme"
            "sass-loader"           
        ]
    })
};
